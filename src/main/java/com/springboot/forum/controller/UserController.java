...
import com.springboot.forum.annotation.LoginRequired;
import com.springboot.forum.entity.User;
import com.springboot.forum.service.FollowService;
import com.springboot.forum.service.LikeService;
...
//    index里面调用后：链接为http://localhost:8080/community/user/header/xxx.png
//    然后进行文件传输
