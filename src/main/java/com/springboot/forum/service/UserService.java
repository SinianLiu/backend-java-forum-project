...
import com.springboot.forum.dao.LoginTicketMapper;
import com.springboot.forum.dao.UserMapper;
import com.springboot.forum.entity.LoginTicket;
...
//      return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) {
        ...
        if (u != null) {
            map.put("usernameMsg", "User name is already used!");
            return map;
        }
        ...
        if (u != null) {
            map.put("emailMsg", "Email is already used!");
            return map;
        }
...
//        %d是占位符，int数值，注意不是dt
        ...
        // 希望服务器用以下路径处理激活请求
        // http://localhost:1234/forum/activation/101/code
